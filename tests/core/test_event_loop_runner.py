...
class TestEventLoopThreadRunner:
    """Test suite for EventLoopThreadRunner class."""

    def test_loop_consistency(self, event_loop_runner: EventLoopThreadRunner) -> None:
    ...
    def test_exception_handling(self, event_loop_runner: EventLoopThreadRunner) -> None:
    ...
    def test_gather_operation(self, event_loop_runner: EventLoopThreadRunner) -> None:
    ...
    def test_loop_state(self, event_loop_runner: EventLoopThreadRunner) -> None:
    ...
    def test_garbage_collection(self, event_loop_runner: EventLoopThreadRunner) -> None:
    ...
    def test_multiple_operations(self, event_loop_runner: EventLoopThreadRunner) -> None:
    ...
    def test_close_idempotent(self, event_loop_runner: EventLoopThreadRunner) -> None:
        """Test that close method is idempotent."""
        event_loop_runner.close()
        event_loop_runner.close()

    def test_run_with_non_coroutine(self, event_loop_runner: EventLoopThreadRunner) -> None:
    ...
    def test_gather_with_exceptions(self, event_loop_runner: EventLoopThreadRunner) -> None:
    ...
    def test_run_timeout(self, event_loop_runner: EventLoopThreadRunner) -> None:
    ...
    def test_schedule_after_close_raises(self, event_loop_runner: EventLoopThreadRunner) -> None:
    ...
    def test_run_from_child_thread(self, event_loop_runner: EventLoopThreadRunner) -> None:
    ...
    def test_gather_empty(self, event_loop_runner: EventLoopThreadRunner) -> None:
        """Test gather with no coroutines returns empty list."""
        results = event_loop_runner.gather()
        assert results == []

    def test_run_with_nested_coroutine(self, event_loop_runner: EventLoopThreadRunner) -> None:
    ...
    def test_gather_with_various_return_types(self, event_loop_runner: EventLoopThreadRunner) -> None:
        """Test gather with coroutines returning different types."""
        async def coro_dict():
            return {"a": 1}
        async def coro_list():
            return [1, 2, 3]
        async def coro_tuple():
            return (1, 2)
    ...
    def test_run_with_custom_exception(self, event_loop_runner: EventLoopThreadRunner) -> None:
    ...
    def test_gather_with_multiple_exceptions(self, event_loop_runner: EventLoopThreadRunner) -> None:
    ...
    def test_run_with_cancelled_coroutine(self, event_loop_runner: EventLoopThreadRunner) -> None:
    ...
    def test_gather_with_cancelled_coroutine(self, event_loop_runner: EventLoopThreadRunner) -> None:
    ...
    def test_run_with_timeout_zero(self, event_loop_runner: EventLoopThreadRunner) -> None:
    ...
    def test_gather_large_data(self, event_loop_runner: EventLoopThreadRunner) -> None:
